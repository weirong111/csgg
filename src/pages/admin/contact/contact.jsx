          ...
          <div>
            <Popconfirm
              ...
              onConfirm={(e) => {
                ...
                axios
                  .delete(
                    "http:/123.60.224.233:8001/changshi/contact/deleteContact/" +
                      props.id
                  )
                  .then((res) => {
                    axios
                      .get(
                        "http://123.60.224.233:8001/changshi/contact/findContact"
                      )
                      .then((res) => {
                        setData(res.data.data.items);
                      })
    ...
    <div>
      <Card
        ...
        extra={
          <Button
            type="primary"
            onClick={() => props.history.push("/admin/contact/edit")}
          >
            新增
          </Button>
        }
